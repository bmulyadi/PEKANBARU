...
<input type="hidden" class="print" 		name="rek_nomor" 	value="<?=$rek_nomor?>"/>
<input type="hidden" class="print" 		name="byr_no"	 	value="<?=$byr_no?>"/>
<input type="hidden" class="print"		name="token" 		value="<?=_TOKN?>"/>
<input type="hidden" class="print" 		name="targetUrl" 	value="print_copy_rek.php"/>
...
<table class="table_info">
	...
	<tr class="table_head"> 
		<td colspan="3">
			...
			<input type="button" class="form_button" value="Cetak Copy Rekening" onclick="cetakin('print')"/>
		</td>				
