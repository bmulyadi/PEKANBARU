		...
		<table border="0" width="100%">
				...
				<!-- Rek Kanan-->
						...
						<tbody><tr>
							...
							<td class="prn_moto_head" width="20%"><?=$row0->byr_serial?></td>
						...
						<tr class="form_cell">
				 		...
				 		<tr class="form_cell">
							<td colspan="5">
<?
	//errorHD::rekLOG(array($row0->rek_nomor,$row0->byr_total));
	//errorHD::tulisLOG(array($row0->pel_no,"Cetak rekening ".$bulan[$row0->rek_bln]." ".$row0->rek_thn),$stsLog);
?>
							</td>
						</tr>
					 	</tbody></table>
