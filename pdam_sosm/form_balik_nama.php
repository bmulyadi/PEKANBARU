...
<?php
	if($proses=="detail"){
		...
		//$param2 = array("kelas"=>"simpan","nama"=>"gol_kode","pilihan"=>$row->gol_kode); 
		$link->tutup();
		//var_dump($result);
?>
...
<table width='100%'>
	...
	<tr height="30px" class="table_cell2">
		...
		<td width="25%" >Nama Pelanggan</td><td>: <input style="font-size: 8pt" type='text' size="25" name='pel_nama' class='simpan' value='<?=$row->pel_nama?>'></td>
	</tr>
	<tr height="30px" class="table_cell1">
